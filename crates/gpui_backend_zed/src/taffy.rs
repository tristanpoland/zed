...
pub(crate) struct BackendWindowLayout {
    engine: TaffyLayoutEngine,
}

impl BackendWindowLayout {
    ...
    pub(crate) fn stretch_auto_size_to_fill(
        &mut self,
        layout_id: LayoutId,
        size: Size<Pixels>,
        scale_factor: f32,
    ...
    pub(crate) fn compute_layout(
        ...
        self.engine
            .compute_layout(layout_id, available_space, window, cx);
    }
    ...
    pub(crate) fn layout_bounds(
        ...
        self.engine.layout_bounds(layout_id, scale_factor)
    }
}
