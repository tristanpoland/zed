...
pub mod types {
    pub use gpui_types::{
        ...
        PlatformCursorSpi, StrongEntityHandle, SubscriptionHandle, TaskHandle, VisualContextSpi,
        WeakEntity, WeakEntityHandle, clipboard, color, geometry, input, platform,
    };
}
