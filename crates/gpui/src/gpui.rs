...
pub mod types {
    pub use gpui_types::{
        ...
        PlatformServicesSpi, PlatformTextInputSpi, Role, StrongEntityHandle, SubscriptionHandle,
        TaskHandle, TextInputAction, TextInputConfiguration, TextInputStateChange, TitlebarOptions,
        Tree, TreeId, TreeUpdate, UTF16Selection, VisualContextSpi, WeakEntity, WeakEntityHandle,
