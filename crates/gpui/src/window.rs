...
use gpui_types::{AnyWindowHandle, WindowId};
...
impl Window {
    ...
    pub fn with_global_id<R>(
        ...
        self.with_id(element_id, |this| {
            let global_id = GlobalElementId::from(Arc::from(&*this.element_id_stack));
...
/// The backend-specialized identity used by GPUI elements.
pub type ElementId = gpui_types::ElementId<FocusId>;
